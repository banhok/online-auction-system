 ...
 * hoặc ta dùng cột chung và parse khi đọc.
 * Ở đây ta dùng cách đơn giản: lưu thêm 1 cột extra_data (JSON).
 */
public class ItemDAO {
    ...
    /**
     * Map ResultSet thành Item (đúng lớp con dựa theo category).
     */
    private Item mapRowToItem(ResultSet rs) throws SQLException {
        ...
        switch (category) {
            case ELECTRONICS:
                ...
                // Parse extra info từ description nếu có
    ...
    // --- Parse helper: trích xuất thông tin riêng từ description ---
    // Format description: "Mô tả chung|brand=X|condition=Y|warranty=Z"
    ...
    /**
     * Build description string chứa thông tin riêng theo category.
     */
    ...
    public void update(Item item) throws SQLException {
        String sql = "UPDATE items SET name = ?, description = ?, category = ?, " +
                     "image_url = ?, starting_price = ?, updated_at = datetime('now') WHERE id = ?";
